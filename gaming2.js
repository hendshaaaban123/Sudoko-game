...
function addRandom(){
    ...
    let source1 = Math.floor(Math.random()*(8-5+1))+5;
    let source2 = Math.floor(Math.random()*(8-5+1))+5;
    let source3 = Math.floor(Math.random()*(8-5+1))+5;
    let source4 = Math.floor(Math.random()*(8-5+1))+5;
