let sorry = document.getElementsByClassName("lose_message");
...
function addRandom(){
    ...
    let source1 = Math.floor(Math.random()*(4-1+1))+1;
    let source2 = Math.floor(Math.random()*(4-1+1))+1;
    let source3 = Math.floor(Math.random()*(4-1+1))+1;
    let source4 = Math.floor(Math.random()*(4-1+1))+1;
